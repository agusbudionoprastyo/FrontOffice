...
$folio = $_GET['folio'];
$query = mysqli_query($conn, "SELECT * FROM FOGUEST WHERE folio='$folio' AND foliostatus='I'");
            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        ...
                        <h1 class="home__data-title"><?= !empty($data['fname']) ? trim(explode(',', $data['fname'])[1]) . '.' . trim(explode(',', $data['fname'])[0]) : '' ?>
                        <!-- <?= trim(explode(',', $data['fname'])[1]) . '.' ?> <b><?= trim(explode(',', $data['fname'])[0]) ?> -->
                        </b></h1>
