...
function printSelectedQRCode() {
    ...
    selectedRows.forEach(function(row) {
        ...
        iframeDocument.write('<div class="label-container">' +
                            ...
                            '<div class="text"><br><b><i class="fa-solid fa-bed"></i></b> ' + row.room + '<br><br><b><i class="fa-solid fa-wifi"></i></b> dafam<br><b><i class="fa-solid fa-key"></i></b> krasansare<br><br></div>' +
                            '</div>' +
...
function printQRCode(folio, room) {
    ...
    iframeDocument.write('<div class="label-container">' +
                        '<div class="text-container">' +
                        '<div class="text"><br><b><i class="fa-solid fa-bed"></i></b> ' + room + '<br><br><b><i class="fa-solid fa-wifi"></i></b> dafam<br><b><i class="fa-solid fa-key"></i></b> krasansare<br><br></div>' +
                        '</div>' +
                        '<div class="qrcode-container"><div class="qrcode"><img src="' + qrCodeUrl + '"></div></div>' +
                        '</div>');
