                        ...
                        <tbody>
                            <?php
                                ...
                                if (isset($_GET['end_date']) && !empty($_GET['end_date'])) {
                                    ...
                                    $sql .= isset($start_date) ? " AND dateco = '$end_date'" : " AND dateco = '$end_date'";
                                }
                            ...
                            ?>
                                <tr>
                                    <td>
                                        <?php if ($row['status'] === '0'): ?>
                                            <a class="btn btn-sm btn-primary mb-md-0 mb-1" href="audit_checked.php?folio=<?php echo $row['folio']; ?>"><i class="fa-solid fa-circle-check fa-xl"></i></a>
                                        <?php endif; ?>
                                        <?php if ($row['status'] === '1'): ?>
