                    ...
                    <table class="table table-hover table-striped w-100" id="table-2">
                        <thead>
                            <tr>
                                ...
                                <th>NAME</th>
                                <th>FOLIO</th>
                                <th data-orderable="false"><input type="checkbox" id="selectAllCheckbox" style="display: none;"></input><label for="selectAllCheckbox"><i class="fa-solid fa-square-check" style="color: #00b37d;"></i> ROOM</label></th>
                                <th>ROOMTYPE</th>
                                <th>ROOM STATUS</th>
                                <th>CHECKIN</th>
                                <th>CHECKOUT</th>
