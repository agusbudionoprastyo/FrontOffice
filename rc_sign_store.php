...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $connection->prepare("UPDATE FOGUEST SET signature_path = ?, at_regform = ?, phone = ?, email = ? WHERE folio = ?");
        if ($stmt === false) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $inputPdfFilename = __DIR__ . '/attachement_pdf/' . 'regcard_nonsmoking.pdf';
